...
1. Клонировать репозиторий: 
	- `git clone https://github.com/Teplitsa/giger.git .` (не забудьте точку в конце, она заставляет клонировать код в ту папку, в которой вы находитесь). Перенести все файлы из папки giger.egg  на уровень выше (т.е. в DocumentRoot): 
	- `mv giger.egg/* ./`
...
3. Запустить: `composer install`. Если не срабатывает, то попробуйте следовать советам по ссылке: https://github.com/Teplitsa/giger/wiki/%D0%A3%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BA%D0%B0, раздел "Уставка без Vagrant на хостинг", п.4.
