...
1. Клонировать репозиторий: 
	...
	- Если команда не срабатывает, то попробуйте следовать советам по ссылке: https://github.com/Teplitsa/giger/wiki/%D0%A3%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BA%D0%B0, раздел "Уставка без Vagrant на хостинг", п.2.
